/**
 * HMI/SCADA extension (see docs/hmi). HMI/SCADA sidebar palette. Adds mxgraph.hmi.* widget/chart/equipment
...
{
	/**
	 * Widgets that paint their own caption hide the cell label; all other
	 * widgets show it below the shape so it never overlaps the value.
	 */
	Sidebar.prototype.hmiSelfLabeled = /shape=mxgraph\.hmi\.(radialGauge|lamp|button|trendChart);/;

	Sidebar.prototype.getHmiLabelStyle = function(style)
	{
		if (style.indexOf('shape=mxgraph.hmi.') < 0 || style.indexOf('noLabel=') >= 0 ||
			style.indexOf('verticalLabelPosition=') >= 0)
		{
			return style;
		}

		return style + (this.hmiSelfLabeled.test(style) ? 'noLabel=1;' :
			'verticalLabelPosition=bottom;verticalAlign=top;');
	};

	Sidebar.prototype.addHmiPalette = function()
	{
		var createVertexTemplateEntry = this.createVertexTemplateEntry;

		this.createVertexTemplateEntry = function(style)
		{
			var args = Array.prototype.slice.call(arguments);
			args[0] = this.getHmiLabelStyle(String(style));

			return createVertexTemplateEntry.apply(this, args);
		};
		...
		{
			this.createVertexTemplateEntry = createVertexTemplateEntry;
		}
	};

	Sidebar.prototype.addHmiPalettes = function()
	{
	...
	Sidebar.prototype.addHmiDisplaysPalette = function()
	{
		...
		[
			this.createVertexTemplateEntry(s + 'numDisplay;fillColor=#ffffff;strokeColor=#90a4ae;fontColor=#263238;' +
				'hmiValue=42.5;hmiDecimals=1;hmiUnit=°C;hmiAlign=center;', 100, 44, '', 'Numeric Display',
			...
			this.createVertexTemplateEntry(s + 'radialGauge;fillColor=none;strokeColor=#cfd8dc;fontColor=#37474f;' +
				'hmiValue=65;hmiMin=0;hmiMax=100;hmiBands=0:60:#2ecc71,60:85:#f1c40f,85:100:#e74c3c;',
			...
			this.createVertexTemplateEntry(s + 'linearGauge;fillColor=#eceff1;strokeColor=#90a4ae;fontColor=#37474f;' +
				'hmiOrientation=vertical;hmiValue=65;hmiFillColor=#2e86de;', 44, 140, '', 'Linear Gauge (Vertical)',
				null, null, dt + 'gauge bar meter level vertical'),
			this.createVertexTemplateEntry(s + 'linearGauge;fillColor=#eceff1;strokeColor=#90a4ae;fontColor=#37474f;' +
				'hmiOrientation=horizontal;hmiValue=65;hmiFillColor=#2e86de;', 160, 44, '', 'Linear Gauge (Horizontal)',
			...
			this.createVertexTemplateEntry(s + 'tank;fillColor=#eceff1;strokeColor=#607d8b;fontColor=#263238;' +
				'tankType=vertical;hmiValue=60;hmiLiquidColor=#3a8ee6;', 90, 150, '', 'Tank (Vertical)',
				null, null, dt + 'tank vessel level cylinder'),
			this.createVertexTemplateEntry(s + 'tank;fillColor=#eceff1;strokeColor=#607d8b;fontColor=#263238;' +
				'tankType=horizontal;hmiValue=60;hmiLiquidColor=#3a8ee6;', 150, 90, '', 'Tank (Horizontal)',
				null, null, dt + 'tank vessel level cylinder horizontal'),
			this.createVertexTemplateEntry(s + 'tank;fillColor=#eceff1;strokeColor=#607d8b;fontColor=#263238;' +
				'tankType=sphere;hmiValue=60;hmiLiquidColor=#3a8ee6;', 130, 130, '', 'Tank (Sphere)',
				null, null, dt + 'tank vessel level sphere ball'),
			this.createVertexTemplateEntry(s + 'tank;fillColor=#eceff1;strokeColor=#607d8b;fontColor=#263238;' +
				'tankType=coneBottom;hmiValue=60;hmiLiquidColor=#3a8ee6;', 110, 150, '', 'Tank (Cone Bottom)',
				null, null, dt + 'tank vessel level cone silo hopper'),
			this.createVertexTemplateEntry(s + 'lamp;strokeColor=#263238;hmiValue=1;hmiOnColor=#2ecc71;' +
				'hmiOffColor=#546e7a;hmiShape=round;', 34, 34, '', 'Indicator Lamp',
			...
			this.createVertexTemplateEntry('html=1;whiteSpace=wrap;shadow=0;' + mxConstants.STYLE_SHAPE + '=mxgraph.hmi.trendChart;' +
				'fillColor=#ffffff;strokeColor=#cfd8dc;fontColor=#455a64;hmiLineColor=#1976d2;',
	...
	Sidebar.prototype.addHmiControlsPalette = function()
	{
		...
		[
			this.createVertexTemplateEntry(s + 'switch;strokeColor=#37474f;hmiValue=1;hmiOnColor=#2ecc71;' +
				'hmiOffColor=#b0bec5;', 70, 32, '', 'Toggle Switch',
				null, null, dt + 'switch toggle on off control'),
			this.createVertexTemplateEntry(s + 'button;fontColor=#ffffff;hmiMode=momentary;hmiOffColor=#3f8ae0;',
				90, 40, 'PUSH', 'Push Button (Momentary)', null, null, dt + 'button push momentary control'),
			this.createVertexTemplateEntry(s + 'button;fontColor=#ffffff;hmiMode=latched;hmiValue=1;hmiOnColor=#2ecc71;' +
				'hmiOffColor=#3f8ae0;', 90, 40, 'START', 'Push Button (Latched)', null, null,
			...
			this.createVertexTemplateEntry(s + 'slider;strokeColor=none;hmiValue=50;hmiOrientation=horizontal;' +
				'hmiThumbColor=#1976d2;', 160, 40, '', 'Slider (Horizontal)', null, null,
			...
			this.createVertexTemplateEntry(s + 'slider;strokeColor=none;hmiValue=50;hmiOrientation=vertical;' +
				'hmiThumbColor=#1976d2;', 40, 160, '', 'Slider (Vertical)', null, null,
	...
	Sidebar.prototype.addHmiChartsPalette = function()
	{
		...
		[
			this.createVertexTemplateEntry(s + 'trendChart;fillColor=#ffffff;strokeColor=#cfd8dc;fontColor=#455a64;' +
				'hmiLineColor=#1976d2;hmiFillArea=1;', 260, 140, 'Flow Rate', 'Trend Chart (Filled)', null, null,
			...
			this.createVertexTemplateEntry(s + 'barChart;fillColor=#ffffff;strokeColor=#cfd8dc;fontColor=#455a64;' +
				'hmiBarColor=#1976d2;hmiOrientation=vertical;', 220, 140, '', 'Bar Chart', null, null,
				dt + 'bar chart graph histogram'),
			this.createVertexTemplateEntry(s + 'barChart;fillColor=#ffffff;strokeColor=#cfd8dc;fontColor=#455a64;' +
				'hmiBarColor=#1976d2;hmiOrientation=horizontal;', 220, 140, '', 'Bar Chart (Horizontal)', null, null,
